...
// update electronic variables, per grid cells
...
//do not heat highly magnetised plasma
...
// aply floors on electronic variables
...
// aply floors on electronic variables, per grid cells
