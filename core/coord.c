...
// find position of grid faces/centers/corners
...
// Establish X coordinates, starting points, and dx
void set_points()
{
#if METRIC == MINKOWSKI
  startx[1] = x1Min;
...
//setup grid stuff, like volume, light crossing time
...
//get convariant and contravarint metric tensors
